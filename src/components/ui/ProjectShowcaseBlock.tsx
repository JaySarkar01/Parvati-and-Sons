  ...
  <div className="max-w-7xl bg-[#f5fcff] p-14 hover:shadow-2xl transition-shadow duration-300 ease-in-out">
    <div className="flex lg:flex-row gap-8 lg:gap-12 items-center flex-col">
      ...
      <div className="w-full lg:w-1/2 space-y-6">
        ...
        {/* Heading */}
        <h2 className="text-4xl md:text-5xl font-bold leading-tight" style={{ color: "#1e1e5a" }}>
          Goodwill Industries of Dallas Inc.
        </h2>

        {/* Description */}
        <p className="text-lg text-gray-700 leading-relaxed">
          Goodwill empowers people with disabilities and other barriers via job training and
          employment at Goodwill and throughout the community.
        </p>
