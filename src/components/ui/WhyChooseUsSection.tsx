...
const WhyChooseUsSection = () => {
  return (
    <div className={`flex flex-col md:flex-row items-start justify-between max-w-7xl mx-auto border-2 border-gray-200 border-dashed rounded-2xl p-8 gap-8 bg-white shadow-sm`}>
