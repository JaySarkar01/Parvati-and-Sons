...
const ReviewCard = ({ review }: { review: Review }) => {
  return (
    <div className="flex-none w-[320px] md:w-[400px] bg-white p-8 rounded-2xl shadow-lg mx-4 my-6 border border-gray-100  transition-all duration-300 hover:shadow-xl hover:-translate-y-1 relative overflow-hidden group">
      {/* Decorative elements */}
      <div className="absolute -top-6 -right-6 w-16 h-16 bg-gradient-to-br from-purple-100 to-purple-50  rounded-full opacity-70"></div>
      <div className="absolute -bottom-8 -left-8 w-24 h-24 bg-gradient-to-tr from-blue-100 to-blue-50  rounded-full opacity-70"></div>

      {/* Quote icon */}
      <div className="absolute top-6 right-6 text-purple-200  opacity-30 group-hover:opacity-60 transition-opacity">
        <Quote size={32} />
      </div>
      ...
      <div className="flex items-center justify-center mb-6 relative">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-xs text-purple-500 font-medium">{review.company}</p>
        </div>
      </div>
    ...
    <section className="py-0 mb-10 bg-white overflow-hidden">
      <div className="container mx-auto px-4 mb-12">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 pb-2 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600">
      ...
      <div className="container mx-auto px-4 mt-5 text-center">
        <div className="inline-flex items-center justify-center px-6 py-3 border border-gray-200 rounded-full text-gray-600 hover:bg-white transition-colors cursor-pointer">
