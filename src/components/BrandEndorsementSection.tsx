...
export default function BrandHeroSection() {
  return (
    <section className="max-w-7xl lg:max-w-[90vw] xl:max-w-[76vw] mx-auto">
      <div className="mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-700 text-lg md:text-xl max-w-lg">
              <span className="font-semibold">Manage your billboard assets</span>, advertising campaigns, CRM
              pipeline, sales, and analytics. All from a single platform.
            </p>

            {/* Buttons */}
            <div className="flex gap-4 flex-wrap">
              <button className="bg-blue-600 hover:bg-blue-500 hover:shadow-xl hover:shadow-blue-100 text-white px-6 py-3 rounded-lg font-medium transition duration-300 shadow-lg">
                Start now
              </button>
              <button className="bg-white border border-blue-200 hover:border-blue-300 hover:shadow-xl text-blue-800 px-6 py-3 rounded-lg font-medium transition duration-300 shadow">
                Meet an advisor
              </button>
            </div>
          </div>
        ...
        <div className="relative w-full h-full min-h-[300px] md:min-h-[400px]">
          ...
          />
          <div className="absolute -bottom-4 -right-4 bg-blue-600 w-24 h-24 rounded-lg hidden md:block" />
        </div>
